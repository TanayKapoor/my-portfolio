...
import { ProjectCommandsSection } from '@/components/ProjectCommands';
...
export default function AdminPanel() {
  ...
  // Commands will be fetched per-project when editing a project
    ...
    <Card className="bg-gray-800/50 border-gray-700">
      ...
      <CardContent>
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          {/* Commands Guide Section - Show for existing projects only */}
          {project && <ProjectCommandsSection projectId={project.id} />}
